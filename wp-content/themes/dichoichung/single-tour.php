            ...
            <div class="no-overflow">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm-7 col-sm-pull-4 hidden-xs hidden-ms">
                        </div>
                        <div class="tour-specs">
                            <div class="col-ms-6 col-sm-3 col-lg-2 tour-spec col-sm-pull-4">
                            ...
                            <div class="col-ms-6 col-sm-3 col-lg-3 tour-spec col-sm-pull-4">
                                <div class="icon-wrapper">
